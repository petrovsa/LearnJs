...
var _viewRecipeJs = require("./views/viewRecipe.js");
...
const controlRecepies = async function() {
    try {
        _viewRecipeJsDefault.default.renderSpiner();
        const { recipe  } = _modelJs.state;
        const id = window.location.hash.slice(1);
        if (!id) return;
        await _modelJs.loadRecipe(id);
        _viewRecipeJsDefault.default.render(_modelJs.state.recipe);
    } catch (err) {
        alert(err);
    }
};
[
    "hashchange",
    "load"
].forEach((event)=>window.addEventListener(event, controlRecepies)
);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq","./model.js":"6Yfb5","./views/viewRecipe.js":"76er3"}],"JacNc":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","regenerator-runtime/runtime":"cH8Iq"}],"76er3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView {
    ...
    renderSpiner() {
        ...
        this.#clean();
        this.#parentElement.insertAdjacentHTML("afterbegin", murkup);
    }
     #generateMarkupIngridient(element) {
        return `\n<li class="recipe__ingredient">\n              <svg class="recipe__icon">\n                <use href="${_iconsSvgDefault.default}#icon-check"></use>\n              </svg>\n              <div class="recipe__quantity">${element.quantity ? new _fractionsDefault.default(element.quantity) : ""}</div>\n              <div class="recipe__description">\n                <span class="recipe__unit">${element.unit}</span>\n                ${element.description}\n              </div>\n            </li>\n    `;
    }
}
exports.default = new RecipeView();

},{"url:../../img/icons.svg":"iwCpK","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","fractions":"eWPGB"}],"iwCpK":[function(require,module,exports) {
...
},{}],"eWPGB":[function(require,module,exports) {
